...
/* harmony default export */ var zoom = ({
  name: 'zoom',
  params: {
    zoom: {
      enabled: false,
...
var App = /*#__PURE__*/function () {
  ...
  app_createClass(App, [{
    ...
    value: function initPages() {
      ...
      in_view_min_default().offset(100);
    }
  }]);
  return App;
}();
document.addEventListener('DOMContentLoaded', function () {
  ...
  Array.from(document.querySelectorAll('.js-smooth-scroll')).forEach(function (link) {
    link.addEventListener('click', function (e) {
      var ankerTarget = e.target;
      e.preventDefault();
      document.querySelector('body').classList.remove('view-nav');
      var targetId = ankerTarget.hash;
      ...
      var buffer = document.querySelector('.top-nav').clientHeight - 20;
